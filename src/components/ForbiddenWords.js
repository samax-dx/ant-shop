...
const WriteForm = ({ recordArg, onRecordSaved,close }) => {
    ...
    return (<>
        ...
        >
            ...
            <Form.Item name="forbiddenWords" label="Fobidden Words" rules={[{ required: true }]} children={<Input />} />
...
const DataView = ({ forbiddenWords, viewPage, viewLimit, onEdit, onDelete }) => {
    ...
    return (<>
        ...
        >
            ...
            />
            <Table.Column title="forbiddenWordsId" dataIndex={"forbiddenWordsId"} />
            <Table.Column title="forbiddenWords" dataIndex={"forbiddenWords"} />
            <Table.Column
                title="Actions"
                dataIndex={undefined}
                render={(value, record, index) => {
                    return (<>
                        <Button onClick={() => console.log("clicked")} type="link">Enable</Button>
                        <Button onClick={() => console.log("clicked")} type="link">Disable</Button>
                            <Button onClick={() => onEdit(record)} type="link">Edit</Button>
                        <Button onClick={() => confirmDelete(record.forbiddenWordsId || console.log(record.forbiddenWordsId))} type="link">Delete</Button>
                        </>
                    );
                }}
            />
...
export const ForbiddenWords = () => {
    ...
    return (<>
        ...
        <DataView forbiddenWords={forbiddenWords} viewLimit={lastQuery.limit} viewPage={lastQuery.page} onEdit={showModal} onDelete={removeforbiddenWordsId} />
