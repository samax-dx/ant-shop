...
export const ReportsService = {
    fetchRecords: (payload) => console.log(payload) || axios
        .post(
            `${CONTACT_BOOK_EP}/admin/reports/campaignRouteAndPartyWiseReports`,
            { ...payload },
            {
                headers: {
    ...
    findAllCampaignForDropdown: (payload) => console.log(payload) || axios
        .post(
            `${CONTACT_BOOK_EP}/admin/Dropdown/AllCampaignForDropdown`,
            { ...payload },
            {
                headers: {
                    'Content-Type': 'application/json',
    ...
    findAllRouteForDropdown: (payload) => console.log(payload) || axios
        .post(
            `${CONTACT_BOOK_EP}/admin/Dropdown/AllRoutesForDropdown`,
            { ...payload },
            {
                headers: {
                    'Content-Type': 'application/json',
